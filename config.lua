...
cfg.locale = 'en' -- Options: 'en', 'lt'
cfg.framework = 'qbcore' -- Options: 'esx', 'qbcore'
cfg.menu = "ox_lib" -- Options: 'ox_lib', "lation_ui"
cfg.notifys = "ox_lib" -- Options: 'ox_lib', "esx", "qbcore", "lation_ui"

-- Do you use command or export to open the menu?
cfg.usecommand = true -- Use command to open the menu
cfg.command = "jobmessage" -- Command to open the menu
